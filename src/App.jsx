...
const CSS=`
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  body{background:#0A0A0F;color:#F0EEF8;font-family:'Figtree',sans-serif;-webkit-tap-highlight-color:transparent;-webkit-font-smoothing:antialiased;height:100%;height:-webkit-fill-available;overflow:hidden;position:fixed;width:100%;overscroll-behavior:none}
